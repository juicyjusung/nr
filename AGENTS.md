...
GitHub Issues is the SSOT for issues, plans, PRDs, scope, acceptance criteria, decisions, blockers, and final verification. See `docs/agents/issue-tracker.md`.
...
Single-context domain documentation layout. See `docs/agents/domain.md`.
